...
export function PortfolioEditDialogHeader({ id }) {
  ...
  // Title couting
  useEffect(() => {
    let _title = id ? "" : "New Portfolio";
    if (portfolioForEdit && id) {
      _title = `Edit portfolio '${portfolioForEdit.firstName} ${portfolioForEdit.lastName}'`;
    }
